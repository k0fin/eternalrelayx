...
if __name__ == '__main__':
    ...
    # A collection of SMB client options which can enumerate SMB information using a non-Admin user's authenticated SMB connection
    ...
    smboptions.add_argument('--enum-shares', action='store_true', required=False, help='If relayed user is not admin, use authenticated relay connection to enumerate SMB shares')

    # A collection of SMB client options which can detect or attack Windows targets vulnerable to EternalBlue using a non-Admin user's authenticated SMB connection
    smboptions.add_argument('--eternalrelay', action='store_true', required=False, help='If relayed user is not admin, use relayed SMB connection for non-admin user to launch EternalBlue against vulnerable Windows targets')
