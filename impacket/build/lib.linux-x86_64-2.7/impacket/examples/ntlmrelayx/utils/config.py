...
class NTLMRelayxConfig:
    def __init__(self):
        ...
        self.enumShares = False
        self.eternalRelayScanner = False
        self.eternalRelayAttack = False
    ...
    def setEnumShares(self, enumShares): # Define a class method for share enumeration
        self.enumShares = enumShares

    def setEternalRelayScanner(self, eternalRelayScanner):
        self.eternalRelayScanner = eternalRelayScanner

    def setEternalRelayAttack(self, eternalRelayAttack):
        self.eternalRelayAttack = eternalRelayAttack
